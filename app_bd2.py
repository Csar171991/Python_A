...
def load_config(config_file='config.json'):
    ...
    import json
    default_config = {
        "dictionary": "input/regex/diccionario.xlsx",
        "database": "input/base.txt",
    ...
    if os.path.exists(config_file):
        ...
        for folder in [default_config["output_folder"], 
                      default_config["error_folder"],
                      default_config["sample_folder"],
                      default_config["report_folder"],
                      default_config["db_ingesta_folder"],
...
def main():
    ...
    def validate_regex_bd(df_bd,df_regex,time_str,hash_generated):
        ...
        for index, row in series.iterrows():
            ...
            if not df_no_matches.empty:
                ...
                df_errors.to_csv(os.path.join(CONFIG['error_folder']+name_errors), index=False, header=True, encoding='latin1')
    ...
    inventary = CONFIG['inventary']
    padron = CONFIG['padron']
    ...
    dfdex.to_csv(os.path.join(CONFIG['sample_folder'], namemuestra_global), index=False, header=True, encoding='latin1')
    ...
    carpeta_origen = CONFIG['report_folder']
    carpeta_destino = CONFIG['db_ingesta_folder']
    ...
    carpeta = 'C:/Users/procesosumc05/Documents/DEPURACION/proyecto_depuracion/output/report/db_ingesta'
    ...
    carpeta2 = 'C:/Users/procesosumc05/Documents/DEPURACION/proyecto_depuracion/input/files'
    ...
    if str(gee['total_duplicates']) == '0':
                ...
                archivo_salida2 = CONFIG['duplicates_file']
    ...
    carpeta_csv = CONFIG['error_folder']
    archivo_reciente_csv = obtener_csv_mas_reciente(carpeta_csv)


    archivo_salida = CONFIG['error_validacion_file']
    ...
    try:
                ...
                time.sleep(20)
                archivo_csv = 'C:/Users/procesosumc05/Documents/DEPURACION/proyecto_depuracion/output/error_validacion_salida.csv'
