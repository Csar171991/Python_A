...
def run_app(base_file, diccionario_file, seccion="app_bd2", task_file=None, job_id=None):
        logger.info("----------------------------------------------------------------------------------------------------")
        logger.info(f"Proceso iniciado: validaciones iniciales para el instrumento sin seccion={seccion} ejecutando..")
        ...
        try:
            ...
            cant_no_corr = len(solo_en_lista2)
